    ...
    <div class="topSystem">
        <div class="system">
            <div class="header-left">
                <div class="logo-container leftMenu" v-show="!isCollapseds">
                    <a href="">
                        <img :src="srcLogo" alt="" />
                    </a>
                </div>
                ...
                <div class="top-menu">
                    <!-- <el-button type="success">菜单1</el-button>
                    <el-button type="success">菜单2</el-button> -->
                </div>
            </div>
            <div class="header-right">
                <div class="topbar-account">
                    ...
                    ><span>djy</span>
                    <el-button type="success" @click="onQuit">退出</el-button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            onIssue() {},
            onQuit() {
                // location.href = this.$store.state.user.logout_url;
                // localStorage.clear();
                // sessionStorage.clear();
                // this.$store.commit("user/onuser", "");
            },
        },
        components: {},
    };
